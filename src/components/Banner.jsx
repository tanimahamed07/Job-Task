...
const Banner = () => {
  return (
    <div className="relative w-full">
      {/* Top Heading Overlay - Desktop Only */}
      ...
      <div className="flex flex-col md:flex-row w-full overflow-hidden">
        ...
        <div className="relative flex-1 h-[150px] md:h-[500px] lg:h-[670px]">
          ...
          <div className="absolute top-12 md:top-[212px] left-0 md:-translate-y-1/2 w-[280px] md:w-[200px] lg:w-[336px] bg-[#8B1D1D] p-3 md:p-4 flex justify-between items-center cursor-pointer hover:bg-[#6b1616] transition-colors border-y-2 md:border-y-3 border-r-2 md:border-r-3 border-gray-400 rounded-r-md shadow-2xl z-20">
        ...
        <div className="relative flex-1 h-[150px] md:h-[500px] lg:h-[670px]">
          ...
          <div className="absolute top-12 md:top-[200px] left-0 md:-translate-y-1/2 w-[280px] md:w-[200px] lg:w-[336px] bg-[#8B1D1D] p-3 md:p-4 flex justify-between items-center cursor-pointer hover:bg-[#6b1616] transition-colors border-y-2 md:border-y-3 border-r-2 md:border-r-3 border-gray-400 rounded-r-md shadow-2xl z-20">
            <span className="text-white font-light md:font-bold text-[20px] md:text-lg lg:text-[20px] leading-tight tracking-tight uppercase md:normal-case">
      ...
      <div className="relative md:absolute md:bottom-3 left-0 w-full text-center px-4 py-8 md:py-0 bg-[#8B1D1D] md:bg-transparent">
        ...
        <div className="grid grid-cols-2 md:flex md:flex-row justify-center gap-3 md:gap-10 max-w-[360px] md:max-w-none mx-auto">
          {["Daily", "Weekly", "Monthly", "Annually"].map((plan) => (
            <button
              key={plan}
              className="bg-white border-2 border-[#8B1D1D] text-black px-4 py-2 md:pl-8 md:pr-0 md:py-2 rounded-md font-bold flex items-center justify-center md:justify-between gap-2 md:gap-0 shadow-lg hover:bg-gray-100 transition-all text-[20px] md:text-base w-full md:w-[125px] cursor-pointer"
            >
              <span>{plan}</span>
              <span className="text-black text-xl font-black md:pr-2">›</span>
            </button>
          ))}
        </div>
      </div>
